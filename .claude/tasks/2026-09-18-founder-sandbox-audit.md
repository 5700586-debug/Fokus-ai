READ-ONLY ARCHITECTURE AUDIT. Do not edit, commit, push, open PR, or deploy.

Repository state is already checked out by GitHub Actions on Linux branch fix/claude-linux-task-runner.
Do not fetch and do not use Windows.
